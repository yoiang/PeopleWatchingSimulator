...
public class ToggleTiltButton : MonoBehaviour {
    ...
    protected void Start() {
        ...
        if (this.walkController == null) {
            Debug.LogError("No WalkController found on player " + this.player, this);
            return;
        }
    }
    ...
    void OnValueUpdated() {
        ...
        Color useColor;
        if (this.walkController.IsUsingDeviceOrientation) {
